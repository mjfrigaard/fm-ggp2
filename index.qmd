...
Welcome to the `ggplot2` field manual! The goal for this resource is to serve as a bookmark/quick reference for building graphs with `ggplot2`.
...
The data packages used in this manual are listed below. You can install them using: 
