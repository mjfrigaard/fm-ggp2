...
Welcome to the ggplot2 field manual! This text contains a collection of code and graphs created using `ggplot2` (and friends!).
...
This manual is designed to help you answer the question, "*what graph should I use?*" 

The structure of this manual assumes the reader has already answered the questions, "*what kind of data do I have?*" and "*who is the audience for the graph?*"

## Other resources

If you want to learn about `ggplot2`, you should start with the [excellent free text](https://ggplot2-book.org/), or if you know what kind of graph you'd like to build, but you need the code or packages in order to build it, check out the [R graph gallery](https://r-graph-gallery.com/ggplot2-package.html) or [R graphics cookbook](https://r-graphics.org/). 
...
### Expand to view an example of the graph code structure
