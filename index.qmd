...
Welcome to the `ggplot2` field manual! This manual intends to be a bookmark/quick reference for building graphs with `ggplot2` (even if you can't quite recall what that graph was called).
...
Another question to consider--but is not covered in this manual--is, "*who will the audience be for this graph?*" 
