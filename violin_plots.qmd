...
![source: Rorschach test, Wikipedia](https://upload.wikimedia.org/wikipedia/commons/7/70/Rorschach_blot_01.jpg){fig-align="right" width="80%"}
:::
...
Map an empty string (`""`) to the `x` and `flipper_length_mm` to the `y`
